...
<Ordered>
  ...
  <li><strong>Builds the recipient URL</strong>: <code>https://console.hippius.com/share/&lt;token&gt;#k=&lt;share_key&gt;</code>. The key is in the <code>#</code> fragment, and browsers never transmit fragments to servers, so Hippius never sees the key.</li>
  <li><strong>Shows the link in a modal</strong> and copies it to your clipboard automatically. The link is live immediately.</li>
</Ordered>
...
<Ordered>
  <li>In the <BgStyledIconWithText text="Files" icon="DocumentText" /> view, find the file you want to share.</li>
  ...
  <li>The share dialog opens and runs the encrypt and upload steps automatically.</li>
  <li>When complete, the share URL is shown in the modal and copied to your clipboard automatically.</li>
