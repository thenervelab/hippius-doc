...
<Unordered>
  ...
  <li><strong>A shared drive</strong> invites people into one of your drives with their own Hippius account and a role, so they can keep working in it with you. Choose <BgStyledText>Share drive…</BgStyledText> in a drive's menu. See <a href="/use/desktop/shared-drives">Shared Drives</a>.</li>
</Unordered>
